const translations = {
    en: {
        ...
        project_karting: "Karting Photography",
        h1_karting: "Karting Photography",
        project_karting_desc: "Racing & Speed.",
        project_astrophoto: "Astrophotography",
        h1_astrophoto: "Astrophotography",
        project_astrophoto_desc: "Night sky & celestial captures.",
        project_portrait: "Portrait Shoot",
        h1_portrait: "Portrait Photography",
        project_portrait_desc: "Urban & lifestyle portrait series.",
        project_fete_musique: "Fête de la Musique",
        h1_fete_musique: "Fête de la Musique - Arras",
        project_fete_musique_desc: "Live concert & event reportage in Arras.",
        ...
        // Project: Astrophoto
        p_astrophoto_desc_1: "A photography series dedicated to capturing the night sky, stars, and celestial landscapes through long exposure.",
        p_astrophoto_approach_1: "Long exposure capture with precise focus in low light conditions, post-processing for noise reduction and contrast enhancement on deep sky and starry landscapes.",
        p_astrophoto_tools_1: "Gear: Sony a6400, 16-50mm f/3.5-5.6 Lens, Tripod",
        p_astrophoto_tools_2: "Software: Adobe Lightroom",
        p_astrophoto_resources_1: "Access full astrophotography database on the Drive.",
        // Project: Portrait
        p_portrait_desc_1: "An outdoor lifestyle portrait photoshoot capturing authentic emotions, expressions, and atmospheric lighting.",
        p_portrait_approach_1: "Work on depth of field, natural ambient lighting, composition, and color grading tailored to highlight personality and mood.",
        p_portrait_tools_1: "Gear: Sony a6400, 16-50mm f/3.5-5.6 and 55-210mm f/4.5-6.3",
        p_portrait_tools_2: "Software: Adobe Lightroom",
        p_portrait_resources_1: "Access full portrait photoshoot on the Drive.",
        // Project: Fete de la Musique
        p_fete_musique_desc_1: "A photo reportage covering the Fête de la Musique in Arras, capturing live performances, the vibrant energy of the artists, and the crowd's emotions.",
        p_fete_musique_approach_1: "Managing changing stage lighting, fast-paced action shots, and alternating between wide crowd angles and telephoto close-ups on musicians.",
        p_fete_musique_tools_1: "Gear: Sony a6400, 16-50mm f/3.5-5.6 and 55-210mm f/4.5-6.3",
        p_fete_musique_tools_2: "Software: Adobe Lightroom",
        p_fete_musique_resources_1: "Access full event album on the Drive.",
        // Project: Hypnose
    ...
    fr: {
        ...
        project_karting: "Photographie Karting",
        h1_karting: "Photographie Karting",
        project_karting_desc: "Course & Vitesse.",
        project_astrophoto: "Astrophotographie",
        h1_astrophoto: "Astrophotographie",
        project_astrophoto_desc: "Série nocturne et captures célestes.",
        project_portrait: "Shooting Portrait",
        h1_portrait: "Photographie Portrait",
        project_portrait_desc: "Série portraits urbains & lifestyle.",
        project_fete_musique: "Fête de la Musique",
        h1_fete_musique: "Fête de la Musique - Arras",
        project_fete_musique_desc: "Reportage concerts et ambiance live à Arras.",
        ...
        // Project: Astrophoto
        p_astrophoto_desc_1: "Une série photographique dédiée à la capture du ciel nocturne, des étoiles et des paysages célestes en pose longue.",
        p_astrophoto_approach_1: "Prises de vue en pose longue, mise au point manuelle de nuit et traitement poussé du contraste et du bruit pour faire ressortir les détails célestes.",
        p_astrophoto_tools_1: "Équipement : Sony a6400, 16-50mm f/3.5-5.6, Trépied",
        p_astrophoto_tools_2: "Logiciel : Adobe Lightroom",
        p_astrophoto_resources_1: "Accédez à la base de données images sur le Drive.",
        // Project: Portrait
        p_portrait_desc_1: "Une séance photo portrait en extérieur capturant des émotions authentiques, des expressions naturelles et une lumière soignée.",
        p_portrait_approach_1: "Travail sur la profondeur de champ, la lumière naturelle d'ambiance, la composition et un étalonnage colorimétrique sur-mesure.",
        p_portrait_tools_1: "Équipement : Sony a6400, 16-50mm f/3.5-5.6 et 55-210mm f/4.5-6.3",
        p_portrait_tools_2: "Logiciels : Adobe Lightroom",
        p_portrait_resources_1: "Accédez à la galerie complète du shooting sur le Drive.",
        // Project: Fete de la Musique
        p_fete_musique_desc_1: "Un reportage photographique réalisé lors de la Fête de la Musique à Arras, capturant l'énergie des artistes sur scène, les performances en direct et les émotions du public.",
        p_fete_musique_approach_1: "Gestion des jeux de lumières dynamiques de concert, réactivité sur les mouvements scéniques et polyvalence entre plans larges d'ambiance et gros plans au téléobjectif.",
        p_fete_musique_tools_1: "Équipement : Sony a6400, 16-50mm f/3.5-5.6 et 55-210mm f/4.5-6.3",
        p_fete_musique_tools_2: "Logiciel : Adobe Lightroom",
        p_fete_musique_resources_1: "Accédez à l'album complet de l'événement sur le Drive.",
        // Project: Hypnose
